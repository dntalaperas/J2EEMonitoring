...
<html>
    <head>
        ...
        <title>test1 Sample html - for github</title>
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div class="box-content clearfix">
                                    ...
                                    <script type="text/javascript">
<%
    ArrayList<TimeMeasureMentEntry> entries_quick = TimeMeasureMentDAO.getTimeMeasurements("Quick Sort");
    ArrayList<TimeMeasureMentEntry> entries_heap = TimeMeasureMentDAO.getTimeMeasurements("Heap Sort");
...
%>                                        
            ...
            function drawChart() {
                var data1 = google.visualization.arrayToDataTable([
                    ['Invocation TimeStamp', 'Duration'],
<% for (int i = 0; i < entries_quick.size(); i++) {%>
                        ['<%=entries_quick.get(i).getDate()%>', <%=entries_quick.get(i).getTime()%>],
<% } %>
                ...
                var data2 = google.visualization.arrayToDataTable([
                    ['Invocation TimeStamp', 'Duration'],
<% for (int i = 0; i < entries_heap.size(); i++) {%>
                        ['<%=entries_heap.get(i).getDate()%>', <%=entries_heap.get(i).getTime()%>],
<% }%>
